...
| 4 | UI — Tabs + seções | Implementar `Tabs` Enviados/Recebidos, seções por tipo, listas de expirados/rejeitados segregadas, data de expiração, botões de ação | in-progress | - | 2, 3 | `.claude/PRPs/plans/invites-management-ui-tabs.plan.md` |
