-- Fix: when filter_type = 'finished', only return patients where pg.has_finished = true.
-- Previous logic: (pg.has_finished = false OR filter_type = 'finished')
-- When filter_type = 'finished', the OR made the entire condition always true,
-- returning all patients regardless of has_finished.
