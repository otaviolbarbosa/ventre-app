-- Add has_finished, born_at and delivery_method from pregnancies to get_filtered_patients return.
-- These fields were being sourced from pregnancies via JOIN LATERAL but not
-- included in the RETURNS TABLE, so RPC callers never received them.
