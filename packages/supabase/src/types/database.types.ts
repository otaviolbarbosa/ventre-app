...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      birth_contractions: {
        Row: {
          ...
          effectiveness: Database["public"]["Enums"]["birth_contraction_effectiveness"] | null;
          id: string;
          measured_at: string;
          pain_intensity: Database["public"]["Enums"]["birth_pain_intensity"] | null;
          patient_id: string;
          pregnancy_id: string;
          professional_id: string;
        };
      ...
      birth_membrane_ruptures: {
        Row: {
          created_at: string;
          fluid_type_at_rupture: Database["public"]["Enums"]["birth_amniotic_fluid_type"] | null;
          id: string;
          occurred_at: string;
          patient_id: string;
          pregnancy_id: string;
          professional_id: string;
          rupture_type: Database["public"]["Enums"]["birth_membrane_rupture_type"] | null;
        };
        Insert: {
          created_at?: string;
          fluid_type_at_rupture?: Database["public"]["Enums"]["birth_amniotic_fluid_type"] | null;
      ...
      birth_urine_tests: {
        Row: {
          created_at: string;
          id: string;
          ketone_level: Database["public"]["Enums"]["birth_urine_dipstick_level"] | null;
          measured_at: string;
          patient_id: string;
          pregnancy_id: string;
          professional_id: string;
          protein_level: Database["public"]["Enums"]["birth_urine_dipstick_level"] | null;
      ...
      pregnancies: {
        Row: {
          ...
          birth_mode_induction_type:
            ...
            | null;
          birth_mode_labour_type: Database["public"]["Enums"]["birth_mode_labour_type"] | null;
    ...
    Enums: {
      ...
      birth_amniotic_fluid_type: "intacto" | "com_sangue" | "claro" | "com_meconio";
      birth_contraction_effectiveness: "efetiva" | "intermediaria" | "nao_efetiva";
      birth_medication_type: "fluidos_intravenosos" | "ocitocina" | "analgesia" | "outros";
      ...
      birth_pain_intensity: "fraca" | "fraca_media" | "media" | "media_forte" | "forte";
      birth_urine_dipstick_level: "ausente" | "tracos" | "uma_cruz" | "duas_cruzes" | "tres_cruzes";
