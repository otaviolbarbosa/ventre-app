			...
			<div className="hero-animate hero-animate-2 relative z-10 w-full max-w-sm">
				<div className="flex flex-col items-center gap-6 px-8 py-10 text-center">
					...
					<p className="text-muted-foreground text-sm leading-relaxed">
						...
						<span className="font-semibold text-primary">Ventre Premium</span> —
						agora você tem acesso completo a todas as ferramentas para cuidar
						das suas gestantes com ainda mais carinho e eficiência.
					</p>
