	...
	const steps = [
		{
			...
			description:
				"Cadastre-se gratuitamente em menos de 2 minutos, sem cartão de crédito.",
		},
		{
			number: "02",
			title: "Monte sua equipe",
			description:
				"Convide obstetras, enfermeiras e doulas para colaborar no cuidado.",
		},
		{
			number: "03",
			title: "Cadastre pacientes",
			description:
				"Adicione suas gestantes e inicie o acompanhamento personalizado.",
		},
		{
			number: "04",
			title: "Acompanhe com qualidade",
			description:
				"Use todas as ferramentas para oferecer o melhor cuidado às suas pacientes.",
		},
	];
				...
				<div className="container relative z-10 mx-auto px-6">
					<div className="max-w-2xl space-y-8 py-24">
						...
						<p className="hero-animate hero-animate-3 max-w-lg text-foreground/60 text-lg leading-relaxed">
							Plataforma completa para profissionais de saúde acompanharem
							gestantes com organização, colaboração em equipe e comunicação
							eficiente.
						</p>
						...
						<div className="hero-animate hero-animate-4 flex flex-wrap items-center gap-3">
							<Link href="/register">
								<Button
									className="gradient-primary gap-2 px-8 font-semibold shadow-soft"
									size="lg"
								>
						...
						<div className="hero-animate hero-animate-5 flex flex-wrap gap-x-5 gap-y-2">
							{trustItems.map((item) => (
								<div
									className="flex items-center gap-1.5 text-foreground/50 text-sm"
									key={item}
								>
				...
				<div className="container mx-auto px-6">
					<div className="mb-16 text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
							Ferramentas pensadas para facilitar seu dia a dia e oferecer o
							melhor cuidado às suas pacientes.
						</p>
					</div>
			...
			<section className="relative overflow-hidden py-28">
				...
				<div className="container relative mx-auto px-6 text-center">
					...
					<p className="mx-auto mb-10 max-w-md text-lg text-white/65">
						Cadastre-se agora e transforme o acompanhamento das suas pacientes.
