...
export function RotatingHeroWord({ words = DEFAULT_WORDS }: RotatingHeroWordProps) {
  ...
  return (
    <span className="relative inline-grid align-bottom">
      ...
      <span aria-live="polite" className="col-start-1 row-start-1 justify-self-start text-left">
        {currentWord.slice(0, charCount)}
        <span aria-hidden className="ml-0.5 animate-caret-blink font-normal text-primary">
          |
        </span>
      </span>
    </span>
